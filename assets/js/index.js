const MainDiv = `<main class="container-fluid"><main class=" ms-sm-auto px-md-4"><div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom"><h1 class="h2">Resumen de movimientos</h1></div><div class="muestra-de-estatus text-black"><h2 class="h6">Como la cuenta es nueva no hay movimientos recientes!</h2></div></main></main>`,
    ...
    RetiroDiv = `<div class="input-group"><span class="input-group-text">Ingrese Cuanto dinero quiere Retirar!</span><input type="number" name="" id="" onkeyup="InputretiroFun(this.value)"><button type="button" class="btn btn-danger" onclick="Withdraw()">Retirar!</button></div>`,
...
function CambioDePantalla() {
    ...
    formBody.remove()
    MuestraDatos = document.querySelector(".muestra-de-estatus")
}
function StartLogin() {
